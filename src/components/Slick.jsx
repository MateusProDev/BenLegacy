  ...
  return (
    <Slider {...settings}>   {/* Passa as configurações definidas para o Slider */}
      ...
      <div className='img-slick'>
        <img src="./img/bannersmart.png" alt="banner1 promoção de pizza" />   {/* Imagem do primeiro slide */}
      </div>
      <div className='img-slick'>
        <img src="./img/bannerpro.png" alt="banner12 promoção de hamburguer" />  {/* Imagem do segundo slide */}
      </div>
    </Slider>
  );
};
